...
const Contact = () => {
  return (
    ...
    <div className="bg-gradient-to-b from-white to-teal-50 py-16 px-4">
      <div className='max-w-6xl mx-auto'>
        ...
        <div className='text-center mb-16'>
          ...
          <div className='w-24 h-1 bg-gradient-to-r from-primary to-teal-400 mx-auto mt-4 rounded-full'></div>
        </div>
        ...
        <div className='flex flex-col items-center justify-center lg:flex-row gap-16'>
          ...
          <div className='lg:w-1/2 bg-white p-8 rounded-xl shadow-lg border border-gray-100'>
            {/* Office Address */}
            <div className='mb-8'>
              <p className='font-semibold text-xl text-primary mb-4 flex items-center'>
            ...
            <div>
              <p className='font-semibold text-xl text-primary mb-4 flex items-center'>
                ...
                {/* ✅ Updated Name to LabMate */}
                Careers at LabMate
              </p>
              <p className='text-gray-600 mb-6'>Learn more about our teams and job openings.</p>
              <button className='bg-primary text-white px-8 py-3 rounded-full font-medium hover:bg-teal-700 transition-all duration-300 shadow-md hover:shadow-lg'>
                Explore Jobs
              </button>
            </div>
          </div>
        ...
        <div className='mt-20'>
          <div className='bg-white p-6 rounded-xl shadow-lg border border-gray-100'>
            ...
            <div className='aspect-w-16 aspect-h-7 rounded-lg overflow-hidden border-2 border-white shadow-md'>
              <iframe 
