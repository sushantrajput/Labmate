...
const Footer = () => {
    return (
        <footer className="bg-gradient-to-b from-white to-teal-50 pt-16 pb-8 px-6 md:px-10 border-t border-gray-100">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
                    ...
                    <div className="md:col-span-1">
                        ...
                        <div className="flex space-x-4">
                            {/* Social Media Icons - Updated to match theme on hover */}
                            <a href="#" className="text-gray-500 hover:text-primary hover:bg-teal-50 p-2 rounded-full transition-all duration-300">
                    ...
                    <div>
                        ...
                        <h3 className="text-lg font-semibold text-gray-800 mb-6 relative pb-2 after:absolute after:bottom-0 after:left-0 after:w-10 after:h-[3px] after:bg-primary after:rounded-full">
                            Quick Links
                        </h3>
                            ...
                            {['Home', 'About us', 'Services', 'Doctors', 'Contact us', 'Privacy policy'].map((item) => (
                                <li key={item}>
                                    <a
                                        ...
                                        className="text-gray-600 hover:text-primary transition-all flex items-center group text-sm font-medium"
                                    >
                                        <span className="mr-2 text-teal-400 opacity-0 group-hover:opacity-100 transition-opacity">→</span>
                    ...
                    <div>
                        ...
                        <ul className="space-y-4">
                            ...
                            <li className="flex items-start">
                                {/* ✅ Icon Background and Color Updated */}
                            ...
                            <li className="flex items-start">
                                ...
                                <div>
                                    <p className="text-gray-700 font-medium">hello@labmate.com</p>
                    ...
                    <div>
                        ...
                        <form className="flex flex-col space-y-3">
                            <input
                                ...
                                // ✅ Input Border Focus Color Updated
                                className="px-4 py-3 w-full rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent text-sm"
                                required
                            />
                            <button
                                type="submit"
                                // ✅ Button Background Updated to Primary
                                className="bg-primary hover:bg-teal-800 text-white px-6 py-3 rounded-lg transition-all flex items-center justify-center space-x-2 shadow-md hover:shadow-lg"
                            >
                                <span>Subscribe</span>
                ...
                <div className="border-t border-gray-200 pt-8">
                    <div className="flex flex-col md:flex-row justify-between items-center">
                        <p className="text-gray-500 text-sm mb-4 md:mb-0">
                            &copy; {new Date().getFullYear()} LabMate. All rights reserved.
                        </p>
