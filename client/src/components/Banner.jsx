...
const Banner = () => {
  ...
  return (
    // ✅ Change 1: Background Gradient to Teal
    <div ref={ref} className="relative overflow-hidden bg-gradient-to-br from-teal-900 to-teal-700 rounded-3xl px-6 sm:px-10 md:px-14 lg:px-20 my-16 mx-4 md:mx-10 shadow-2xl">
      ...
      {/* ✅ Change 2: Decorative Circles to Teal */}
      ...
      <motion.div className="relative z-10 flex flex-col md:flex-row items-center py-10 md:py-0" initial="hidden" animate={controls} variants={container}>
        <div className="flex-1 py-10 md:py-12 lg:py-14">
          <motion.h1 variants={item} className="text-4xl sm:text-5xl md:text-[3rem] lg:text-[3.5rem] font-bold text-white leading-tight tracking-tight">
            ...
            {/* ✅ Change 3: Text Highlight to Teal-200 */}
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-teal-200 to-white">At Your Fingertips</span>
          </motion.h1>
          
          {/* ✅ Change 4: Subtext color */}
          ...
          <motion.div variants={item} className="flex flex-col sm:flex-row gap-3">
            <motion.button whileHover={{ scale: 1.03, boxShadow: "0 10px 25px -5px rgba(255,255,255,0.1)" }} whileTap={{ scale: 0.98 }}
              ...
              // ✅ Change 5: Button text color to Primary Teal
        ...
        <motion.div className="hidden md:block md:w-1/2 lg:w-[420px] relative min-h-[320px]" variants={item}>
          {/* ✅ Change 6: Image Border */}
          <img src={assets.appointment_img} alt="Doctor consultation" loading="lazy" className="w-full h-auto object-contain translate-y-6 rounded-tl-[100px] rounded-br-2xl border border-teal-800/30 shadow-2xl" />

          {/* Floating Cards Updated to Teal */}
          ...
          <motion.div className="absolute bottom-14 left-0 bg-gradient-to-br from-teal-500 to-teal-700 rounded-2xl shadow-2xl p-4 w-60 z-20 text-white"
