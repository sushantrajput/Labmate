  ...
  return (
    <form onSubmit={onSubmitHandler} className='m-5 w-full'>
      ...
      <div className='bg-white px-8 py-8 border rounded w-full max-w-4xl max-h-[80vh] overflow-y-scroll'>
        ...
        {/* ✅ FIXED: Button is now Teal-600 to be visible */}
        <button type='submit' className='bg-teal-600 px-10 py-3 mt-4 text-white rounded-full hover:bg-teal-700 transition-all'>
          Add Doctor
        </button>
